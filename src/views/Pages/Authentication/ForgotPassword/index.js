...
import { Alert, AlertTitle, Box, FormControl, FormHelperText, Grid, InputLabel, OutlinedInput, Typography } from '@mui/material';
...
const ForgotPassword = () => {
  ...
  useEffect(() => {
    document.title = 'DigiLib | Forgot Password';
  }, []);
  ...
  return (
    <AuthWrapper>
      <Grid container spacing={gridSpacing}>
        {/* Col 1 */}
        <Grid item md={7} sx={{ display: { xs: 'none', sm: 'none', md: 'block' } }}>
          <Grid container alignItems="center">
            <Grid item xs={12} md={8}>
              <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="600" height="350" viewBox="0 0 951.23547 632.16225">
                <path
                ...
                <path
                  ...
                  fill="#517dd2"
                />
                <circle cx="540.23547" cy="106.16225" r="15" fill="#517dd2" />
                <circle cx="643.23547" cy="106.16225" r="15" fill="#517dd2" />
                <circle cx="746.23547" cy="106.16225" r="15" fill="#517dd2" />
                <circle cx="849.23547" cy="106.16225" r="15" fill="#517dd2" />
              </svg>
            </Grid>
          </Grid>
        </Grid>
        ...
        <Grid item xs={12} md={5}>
          <Grid container alignItems="center">
            <Grid item sx={{ mb: 2, textAlign: 'center' }} xs={12}>
              <Logo width={100} />
            ...
            <Grid item sx={{ mb: 2 }} xs={12}>
              <Formik
                ...
                onSubmit={async (values, { setErrors, setStatus, setSubmitting, resetForm }) => {
                  await submitForgotPassword(values.email).then((res) => {
                    try {
                      if (res && res.status !== 201) {
                        ...
                        navigation('/reset-password-request/success');
                      }
                    } catch (error) {
