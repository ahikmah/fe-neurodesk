...
const RegisterForm = ({ ...others }) => {
  ...
  const { submitRegisterSA } = useAuth();
    ...
    <>
      ...
      <Formik
        ...
        validationSchema={Yup.object().shape({
          ...
          token: Yup.string().max(100).required('Token is required'),
        })}
        onSubmit={async (values, { setErrors, setStatus, setSubmitting, resetForm }) => {
          await submitRegisterSA(values.full_name, values.email, values.password, values.token).then((res) => {
            try {
            ...
            <>
              ...
              <form noValidate onSubmit={handleSubmit} {...others}>
                ...
                <FormControl fullWidth error={Boolean(touched.token && errors.token)} sx={{ ...theme.typography.customInput }}>
                  <InputLabel htmlFor="outlined-adornment-token-register">Token</InputLabel>
                  <OutlinedInput
                    id="outlined-adornment-token-register"
                  ...
                  {touched.token && errors.token && (
                    <FormHelperText error id="standard-weight-helper-text-token-register">
                      {errors.token}
                    </FormHelperText>
                  )}
                </FormControl>
