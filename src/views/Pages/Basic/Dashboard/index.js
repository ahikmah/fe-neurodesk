      ...
      <div className="App">
        ...
        <div>
          <div className="margin-bottom-md">
            <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="500" viewBox="0 0 979.32677 424.8366">
              <path
          ...
          <p className="heading-primary margin-bottom-sm">Hi, There!</p>
          <p className="subheading">Having problems or complaints with our app? Tell our team and we will help you right away!</p>
          <Button variant="contained" onClick={() => navigate('/new-ticket')} startIcon={<NoteAddIcon />}>
            Create New Ticket
          </Button>
        </div>
      </div>
